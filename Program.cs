    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Dictionary<string, string> intriguedWord = new Dictionary<string, string>{
                { "word", "intrigued" },
                { "definition", "to strongly draw the interest of; puzzle; fascinate" },
                { "part of speech", "verb"},
                { "example sentence", "I am intrigued by C#."}
            };
            dictionaryOfWords.Add(intriguedWord);
